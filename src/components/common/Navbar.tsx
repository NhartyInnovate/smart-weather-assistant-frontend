    ...
    <header className="fixed inset-x-0 top-0 z-40 border-b border-white/5 bg-slate-950/10 backdrop-blur-md shadow-sm">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 sm:py-5">
        <a href="#top" className="flex items-center gap-2 text-white group">
          <Planet weight="duotone" size={26} className="text-blue-200 transition-colors group-hover:text-white" aria-hidden />
          <span className="text-[15px] font-semibold tracking-wide text-white/90">Aero Weather</span>
        </a>
